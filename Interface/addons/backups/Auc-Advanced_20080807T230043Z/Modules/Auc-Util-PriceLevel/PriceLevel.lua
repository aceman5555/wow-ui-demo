--[[
	...
	Revision: $Id: PriceLevel.lua 2530 2007-11-18 22:18:59Z mentalpower $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-PriceLevel/PriceLevel.lua $", "$Rev: 2530 $")