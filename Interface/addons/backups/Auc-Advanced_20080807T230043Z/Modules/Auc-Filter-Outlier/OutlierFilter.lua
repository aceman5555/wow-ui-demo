--[[
	...
	Revision: $Id: OutlierFilter.lua 2531 2007-11-18 22:29:16Z mentalpower $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 2531 $")