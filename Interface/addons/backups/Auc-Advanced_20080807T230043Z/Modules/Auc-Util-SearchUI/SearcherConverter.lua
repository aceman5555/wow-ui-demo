--[[
	...
	Revision: $Id: SearcherConverter.lua 3091 2008-05-04 16:37:11Z testleK $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherConverter.lua $", "$Rev: 3091 $")