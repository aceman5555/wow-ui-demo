--[[
	...
	Revision: $Id: CoreUtil.lua 3150 2008-06-02 03:09:34Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Advanced/CoreUtil.lua $", "$Rev: 3150 $")
