--[[
	...
	Revision: $Id: BasicFilter.lua 2535 2007-11-19 00:50:12Z speeddymon $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Filter-Basic/BasicFilter.lua $", "$Rev: 2535 $")