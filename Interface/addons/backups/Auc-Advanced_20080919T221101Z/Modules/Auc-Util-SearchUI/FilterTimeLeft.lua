--[[
	...
	Revision: $Id: FilterTimeLeft.lua 3230 2008-07-11 20:43:16Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/FilterTimeLeft.lua $", "$Rev: 3230 $")