--[[
	...
	Revision: $Id: SearcherConverter.lua 3229 2008-07-11 20:16:39Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherConverter.lua $", "$Rev: 3229 $")