--[[
	...
	Revision: $Id: SearcherDisenchant.lua 3236 2008-07-16 22:04:57Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/SearcherDisenchant.lua $", "$Rev: 3236 $")