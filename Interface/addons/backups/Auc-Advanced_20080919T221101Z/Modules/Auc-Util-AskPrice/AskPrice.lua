--[[
	...
	Revision: $Id: AskPrice.lua 3175 2008-06-23 06:30:05Z MentalPower $
...
function private.GetVersion()
	return tonumber(("$Revision: 3175 $"):match("(%d+)")), (AucAdvanced.GetCurrentRevision()) --We just want the first return from GetCurrentRevision()
end
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 3175 $")