--[[
	...
	Revision: $Id: CoreBuy.lua 3238 2008-07-17 13:25:08Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Advanced/CoreBuy.lua $", "$Rev: 3238 $")
