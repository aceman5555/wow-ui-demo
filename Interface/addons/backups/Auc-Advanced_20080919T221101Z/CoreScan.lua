--[[
	...
	Revision: $Id: CoreScan.lua 3227 2008-07-11 04:58:54Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Advanced/CoreScan.lua $", "$Rev: 3227 $")
