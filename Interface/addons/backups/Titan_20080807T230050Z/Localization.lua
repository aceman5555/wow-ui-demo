function TitanLocalizeEN()
	...
	TITAN_RIDER_STATES = {"On foot", "On mount", "On flying mount", "In flight", "Swimming", "Sheeped"};
	TITAN_RIDER_ITEMS = 4;
	TITAN_RIDER_ITEM_NAMES = {nil,"Carrot on a Stick",nil,"Riding Crop"};
	TITAN_RIDER_ITEM_DESCS = {"Mithril Spurs",nil,"Minor Mount Speed Increase",nil};
	TITAN_RIDER_ITEM_SLOTS = {"FeetSlot","Trinket0Slot","HandsSlot","HeadSlot"}
