--[[
	...
	Revision: $Id: CoreUtil.lua 3038 2008-04-15 01:22:27Z Hirsute $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Advanced/CoreUtil.lua $", "$Rev: 3038 $")
