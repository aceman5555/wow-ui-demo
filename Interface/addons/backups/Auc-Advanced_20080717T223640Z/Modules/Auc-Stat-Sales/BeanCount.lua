--[[
	...
	Revision: $Id: BeanCount.lua 3075 2008-05-01 07:17:47Z Kinesia $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Stat-Sales/BeanCount.lua $", "$Rev: 3075 $")