--[[
	...
	Revision: $Id: ScanButton.lua 2996 2008-04-02 03:23:30Z kandoko $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-ScanButton/ScanButton.lua $", "$Rev: 2996 $")
