--[[
	...
	Revision: $Id: AskPrice.lua 2825 2008-02-02 03:22:12Z rockslice $
...
function private.GetVersion()
	return tonumber(("$Revision: 2825 $"):match("(%d+)"))
end
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 2825 $")