--[[
	...
	Revision: $Id: ScanFinish.lua 2621 2007-12-03 02:00:40Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-ScanFinish/ScanFinish.lua $", "$Rev: 2621 $")