--[[
	...
	AddOn: Gatherer
	Revision: $Id: GatherStrings.lua 494 2007-02-21 00:12:24Z esamynn $
...
GathererLocalizations = {
	...
	daDK = {
		...
		ORE_BLOODSTONE	= "Blodsten";
		ORE_COPPER	= "Kobber";
		ORE_DARKIRON	= "mørk jern";
	...
	deDE = {
		...
		-- Section: Node Category Names
		ORE_ADAMANTITE	= "Adamantit";
		ORE_BLOODSTONE	= "Geringes Blutstein";
		ORE_COPPER	= "Kupfer";
	...
	ruRU = {
		...
		-- Section: Node Category Names
		ORE_ADAMANTITE	= "Адамант";
		ORE_COPPER	= "Медь";
		ORE_DARKIRON	= "Темное железо";
		ORE_GOLD	= "Золото";
		ORE_INDURIUM	= "Индуриум";
		ORE_IRON	= "Железо";
		ORE_MITHRIL	= "Мифрил";
		ORE_OBSIDIAN	= "Обсидан";
		ORE_RADAMANTITE	= "Большой Адамант";
		ORE_RTHORIUM	= "Большой Ториум";
		ORE_SILVER	= "Серебро";
		ORE_THORIUM	= "Ториум";
		ORE_TIN	= "Олово";
		ORE_TRUESILVER	= "Истинное Серебро";
		TREASURE_BARREL	= "Бочонок";
		TREASURE_BOX	= "Коробка";
		TREASURE_CASK	= "Бочка";
		TREASURE_CRATE	= "Ящик";
		TREASURE_SHELLFISHTRAP	= "Раковина моллюска";


		-- Section: Node Tooltip Messages
		NOTE_COUNT	= "Собрано за %1 времени";
		NOTE_DISTANCE	= "Дистанция: %1 ярд";
		NOTE_SOURCE	= "Источник: %1";


		-- Section: Trade Skill Names
		TRADE_HERBALISM	= "Гербализм";
		TRADE_MINING	= "Шахтерство";
