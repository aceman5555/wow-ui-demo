--[[
	...
	Revision: $Id: GatherConvert.lua 492 2007-02-18 08:27:18Z esamynn $
...
--]]
Gatherer_RegisterRevision("$URL: http://norganna.org/svn/gatherer/trunk/GatherConvert.lua $", "$Rev: 492 $")
...
local function extractNodeInformation()
	...
	MergeNode(unpack(nodeData, 1, 10))
end
...
ConversionInformation = {
	...
	[0] = {
		...
		typeConverstionData = {
			...
			[4] = "number",
			[5] = {
				number = function(data) return data / 100 end,
			},
			[6] = {
				number = function(data) return data / 100 end,
			},
