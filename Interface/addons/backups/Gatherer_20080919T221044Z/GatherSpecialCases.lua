--[[
	...
	Revision: $Id: GatherSpecialCases.lua 492 2007-02-18 08:27:18Z esamynn $
...
Gatherer_RegisterRevision("$URL: http://norganna.org/svn/gatherer/trunk/GatherSpecialCases.lua $", "$Rev: 492 $")
