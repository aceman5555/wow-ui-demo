--[[
	...
	Revision: $Id: GatherDropRates.lua 496 2007-02-26 01:59:10Z esamynn $
...
Gatherer_RegisterRevision("$URL: http://norganna.org/svn/gatherer/trunk/GatherDropRates.lua $", "$Rev: 496 $")
...
function Gatherer.DropRates.Load()
	...
	if ( type(data) == "table" ) then
		if not ( dbVersion == data.dbVersion ) then
			-- do any conversions here
			
			--for the moment, just clear the data if versions don't match
