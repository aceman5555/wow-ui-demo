--[[
	...
	Revision: $Id: GatherMain.lua 460 2007-02-04 08:12:28Z esamynn $
...
Gatherer_RegisterRevision("$URL: http://norganna.org/svn/gatherer/trunk/GatherMain.lua $", "$Rev: 460 $")

Gatherer.Var.Version="2.99.0.0498"
if (Gatherer.Var.Version == "<%".."version%>") then
	Gatherer.Var.Version = "2.99-DEV"
end
Gatherer.Version = Gatherer.Var.Version

Gatherer.AstrolabeVersion = "Astrolabe-0.3"
