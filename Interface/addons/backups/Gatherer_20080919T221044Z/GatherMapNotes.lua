--[[
	...
	Revision: $Id: GatherMapNotes.lua 496 2007-02-26 01:59:10Z esamynn $
...
Gatherer_RegisterRevision("$URL: http://norganna.org/svn/gatherer/trunk/GatherMapNotes.lua $", "$Rev: 496 $")
			...
			if ( Gatherer.Config.DisplayFilter_MainMap(nodeId) ) then
				for index, xPos, yPos, count in Gatherer.Storage.ZoneGatherNodes(mapContinent, mapZone, nodeId) do
					if ( noteCount < maxNotes ) then
						...
						mainNote:SetAlpha(setting("mainmap.percent", 80) / 100)
