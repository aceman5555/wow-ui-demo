--[[
	...
	Revision: $Id: GatherManifest.lua 418 2007-01-12 18:24:19Z norganna $
...
manifest.revs = { }
manifest.dist = {
	["trunk/GatherApi.lua"] = 496,
	["trunk/GatherComm.lua"] = 490,
	["trunk/GatherCommand.lua"] = 490,
	["trunk/GatherConfig.lua"] = 492,
	["trunk/GatherConstants.lua"] = 491,
	["trunk/GatherConvert.lua"] = 492,
	["trunk/GatherDropRates.lua"] = 496,
	["trunk/GatherEvent.lua"] = 496,
	["trunk/GatherLocale.lua"] = 474,
	["trunk/GatherMain.lua"] = 460,
	["trunk/GatherManifest.lua"] = 418,
	["trunk/GatherMapNotes.lua"] = 496,
	["trunk/GatherMiniIcon.lua"] = 490,
	["trunk/GatherMiniNotes.lua"] = 496,
	["trunk/GatherObjects.lua"] = 496,
	["trunk/GatherSpecialCases.lua"] = 492,
	["trunk/GatherStorage.lua"] = 493,
	["trunk/GatherTooltip.lua"] = 496,
	["trunk/GatherUtil.lua"] = 496,
	["trunk/GatherZoneTokens.lua"] = 460,
	["trunk/GatherMain.xml"] = 417,
	["trunk/GatherMapNotes.xml"] = 426,
	["trunk/GatherMiniNotes.xml"] = 424,
}
...
function manifest.RegisterRevision(path, revision)
	...
	if (nLog) then
		nLog.AddMessage("Gatherer", "GathererRevision", N_INFO, "Loaded revisioned file", "Loaded", file, "revision", rev)
	end
end
...
Gatherer_RegisterRevision("$URL: http://norganna.org/svn/gatherer/trunk/GatherManifest.lua $", "$Rev: 418 $")
