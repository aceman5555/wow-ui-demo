function TitanLocalizeEN()
     ...
     TITAN_PANEL_ERROR_DUP_PLUGIN = " appears to be registered twice. This may cause Titan Panel to fail, please correct this problem."
     ...
     TITAN_PANEL_REVISION = "Rev 606";
     TITAN_PANEL_VERSION_INFO = "|cffffffff by the |cffff8c00Titan Dev Team".." |cffffffff(HonorGoG, jaketodd422, joejanko, Lothayer, Tristanian, oXidFoX)";
     ...
     TITAN_AMMO_THROWN_KEYWORD = "Thrown";
     ...
     TITAN_RIDER_STATES = {"Running", "Mounted", "Flying", "Taxied", "Swimming", "Sheeped"};
     TITAN_RIDER_ITEMS = 6;
     TITAN_RIDER_ITEMS_LABEL = "Rider Items";
     TITAN_RIDER_ITEM_NAMES = {"Boots w/Mithril Spurs","Gloves w/Riding Enchant","Carrot on a Stick","Riding Crop","Skybreaker Whip","Charm of Swift Flight"};
     TITAN_RIDER_ITEM_DESCS = {"+4%% Mount Speed","+2%% Mount Speed","Carrot on a Stick","Riding Crop","Skybreaker Whip","Charm of Swift Flight"};
     ...
     TITAN_TRANS_TOOLTIP_HINT1 = "Hint: Left-click to adjust the transparency";
     TITAN_TRANS_TOOLTIP_HINT2 = "of the panel.";
     TITAN_TRANS_CONTROL_TOOLTIP = "Main Bar Transparency: ";
     TITAN_AUXTRANS_CONTROL_TOOLTIP = "Auxiliary Bar Transparency: ";
     TITAN_TRANS_MAIN_CONTROL_TITLE = "Main\nBar";
     TITAN_TRANS_AUX_CONTROL_TITLE = "Auxiliary\nBar";
     TITAN_TRANS_CONTROL_HIGH = "100%";
     TITAN_TRANS_CONTROL_LOW = "0%";
     TITAN_TRANS_MENU_TEXT = "Panel Transparency";
     
     TITAN_UISCALE_TOOLTIP = "Panel Control";
     ...
     TITAN_UISCALE_TOOLTIP_HINT1 = "Hint: Left-click to adjust the size of the panel";
     TITAN_UISCALE_TOOLTIP_HINT2 = "and manipulate various aspects of it.";
     ...
     TITAN_UISCALE_CONTROL_TITLE_BUTTON = "Button\nSpacing";
     TITAN_UISCALE_CONTROL_TITLE_TOOLTIPTRANS = "Tooltip\nAlpha";
     TITAN_UISCALE_CONTROL_TITLE_TOOLTIPFONT = "Tooltip\nFont";
     ...
     TITAN_VOLUME_MENU_TEXT = "Volume Adjust";
