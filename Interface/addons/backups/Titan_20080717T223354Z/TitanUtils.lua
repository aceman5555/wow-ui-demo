...
--function TitanUtils_StartAutoHideCounting(frame)
	...
	-- Toggle menu
-- support for Titan Gold Tracker
--if TITAN_PANEL_SELECTED == "GoldTrackerButtonGold" or  TITAN_PANEL_SELECTED == "GoldTrackerButtonSilver" or  TITAN_PANEL_SELECTED == "GoldTrackerButtonCopper" then
		--TITAN_PANEL_SELECTED = "GoldTracker"
	--end
...
function TitanPanelToggleDropDownMenu(level, value, dropDownFrame, anchorName, xOffset, yOffset)
	if ( not level ) then
		level = 1;
	end
