function TitanLocalizeEN()
	...
	TITAN_PANEL_VERSION_INFO = "|cffffffff by the |cffBB33BBTitan Dev Team".." |cffffffff(HonorGoG, jaketodd422, joejanko, Lothayer, Tristanian, oXidFoX)";
	...
	TITAN_RIDER_STATES = {"On Foot", "On Mount", "Flying", "On Taxi", "Swimming", "Sheeped"};
	TITAN_RIDER_ITEMS = 6;
	TITAN_RIDER_ITEMS_LABEL = "Rider Items";
	TITAN_RIDER_ITEM_NAMES = {nil,"Carrot on a Stick",nil,"Riding Crop","Skybreaker Whip","Charm of Swift Flight"};
	TITAN_RIDER_ITEM_DESCS = {"Mount Speed",nil,"Minor Mount Speed Increase",nil,nil,nil};
