...
DBM_REVISION = tonumber(("$Revision: 267 $"):sub(12, -3) or 0) + 783 -- 783 = revision number from the old SVN repository
DBM_VERSION = "3.20" -- this version is used for /dbm ver commands
