--[[
	...
	Revision: $Id: MatchBeanCount.lua 3104 2008-05-08 13:55:32Z RockSlice $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/MatchBeanCount.lua $", "$Rev: 3104 $")