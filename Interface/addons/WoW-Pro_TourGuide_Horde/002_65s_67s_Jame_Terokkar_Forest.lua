...
TourGuide:RegisterGuide("[WoW-Pro | Jame's] Terokkar Forest (Scryer, 65-67)", "[WoW-Pro | Jame's] Nagrand (67-69)", "Horde", function()
return [[
...
A Voren'thal the Seer|QID|10553| |T|
T Voren'thal the Seer |QID|10553| |N|In the large building straight ahead as you take the elevator up to the Aldor rise.| |T|
h Shattrath City |N|(56.2,81.6) |T||Z|Shattrath City|
...
T The Eyes of Skettis |QID|10847| |N|Back in Shattrath, northwestern Lower City.| |T|
...
C The Final Code |QID|10047| |N|Clear to the mana bomb in the centre, and right click to set it off. You get about 10 seconds to get clear, the only thing that happens if you don't is you get knocked down. (71.3,37.3)|
...
C A Hero is Needed |QID|10914| |N|Do these quests on your way back west to the Sha'tar Base Camp. It's at (31,76).|
C Helping the Lost Find Their Way |QID|10031|
...
N Repair, restock and vendor junk.
N Level Check: 65|N|If you aren't level 65 yet, go to Firewing Point (70,39) and grind on the blood elves until you are level 65 with 50000XP in the level. This spot is quite decent for money making, but most importantly you'll get a lot of Firewing Signets for your Scryers faction. I suggest to turn them all in immediately when you get back to Shattrath, because they will become useless once you're honored with the Scryers. They can be turned it at the Scryers' tier, the quest is called [65] Firewing Signets.|
]]
end)
