...
function TitanPanelGuildButton_BuildInteractionMenu()
	...
	info.func = function() TitanPanelGuildButton_GuildWhisper(UIDROPDOWNMENU_MENU_VALUE) end;
	UIDropDownMenu_AddButton(info, UIDROPDOWNMENU_MENU_LEVEL);			
	-- invite
	info = {};
	info.text = TITAN_GUILD_MENU_ADVANCED_INVITE_TEXT;
	info.value = UIDROPDOWNMENU_MENU_VALUE;
	info.func = function() TitanPanelGuildButton_InviteToGroup(UIDROPDOWNMENU_MENU_VALUE) end;
	UIDropDownMenu_AddButton(info, UIDROPDOWNMENU_MENU_LEVEL);
	-- who
	info = {};
	info.text = TITAN_GUILD_MENU_ADVANCED_WHO_TEXT;
	info.value = UIDROPDOWNMENU_MENU_VALUE;
	info.func = function() TitanPanelGuildButton_SendWhoRequest(UIDROPDOWNMENU_MENU_VALUE) end;
	UIDropDownMenu_AddButton(info, UIDROPDOWNMENU_MENU_LEVEL);
	-- friend
	info = {};
	info.text = TITAN_GUILD_MENU_ADVANCED_FRIEND_TEXT;
	info.value = UIDROPDOWNMENU_MENU_VALUE;
	info.func = function() TitanPanelGuildButton_AddFriend(UIDROPDOWNMENU_MENU_VALUE) end;
	UIDropDownMenu_AddButton(info, UIDROPDOWNMENU_MENU_LEVEL);	
end
