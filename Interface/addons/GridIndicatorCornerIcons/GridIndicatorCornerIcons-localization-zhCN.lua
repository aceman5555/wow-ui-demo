...

{
	...
	["Icon Border Size"] = "图标边框尺寸",
	["Adjust the size of the icon's border."] = "调整图标边框尺寸。",
	["Enable Icon Stack Text"] = "图标叠加数量文字",
	["Toggle icon's stack count text."] = "启用图标叠加数量文字。",
	["Enable Icon Cooldown Frame"] = "图标冷却时钟",
	["Toggle icon's cooldown frame."] = "启用图标冷却时钟框架。",

	["Icon Stack Text: Font Size"] = "图标叠加数量:文字大小",
	["Adjust the font size for Icon Stack Text."] = "调整图标叠加数量的文字大小。",
	["Icon Stack Text: Offset X-axis"] = "图标叠加数量文字:X-轴 偏移量",
	["Adjust the offset for Icon Stack Text of the X-axis."] = "调整图标叠加数量文字的X-轴偏移量。",
	["Icon Stack Text: Offset Y-axis"] = "图标叠加数量文字:Y-轴 偏移量",
	["Adjust the offset for Icon Stack Text of the Y-axis."] = "调整图标叠加数量文字的Y-轴偏移量。",

	["Same settings as Grid"] = "使用Grid设置",
	["If enabled, the settings for the Icon (Corners) indicators are adjustable with the standard Grid options. If deactivated, you can set individual settings for the Icon (Corners) indicators."] = "如果启用,将使用Grid的设置来显示角落图标.如果取消,你可以对角落图标进行单独的设置和调整。",

	["Configuration Mode"] = "配置模式",
	["Shows all Icon (Corners) indicators."] = "显示所有角落图标。",
}
