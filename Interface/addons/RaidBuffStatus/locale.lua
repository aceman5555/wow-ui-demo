...
La["Announcement options for raid utilities like Feasts"] = "Option des annonces des utilitaires de raids comme les festins" -- Needs review
...
La["has set us up a %s"] = "a sorti un %s" -- Needs review
...
La["Utility announcements"] = "Annonces utilitaires" -- Needs review
